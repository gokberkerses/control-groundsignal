...
void set_params(ros::ServiceClient set_max_vel_client_1, ros::ServiceClient set_max_vel_client_2)
{
    ...
    mavros_msgs::ParamSet param_cruise_90_1;
    param_cruise_90_1.request.param_id = "MPC_CRUISE_90";
    param_cruise_90_1.request.value.real = 2.0;
    ...
    mavros_msgs::ParamSet param_z_vel_max_1;
    param_z_vel_max_1.request.param_id = "MPC_Z_VEL_MAX_UP";
    param_z_vel_max_1.request.value.real = 1.0;
    ...
    mavros_msgs::ParamSet param_cruise_90_2;
    param_cruise_90_2.request.param_id = "MPC_CRUISE_90";
    param_cruise_90_2.request.value.real = 2.0;
    ...
    mavros_msgs::ParamSet param_z_vel_max_2;
    param_z_vel_max_2.request.param_id = "MPC_Z_VEL_MAX_UP";
    param_z_vel_max_2.request.value.real = 1.0;
    ...
    if(set_max_vel_client_1.call(param_cruise_90_1))
    {
    ...
    if(set_max_vel_client_1.call(param_z_vel_max_1))
    {
    ...
    if(set_max_vel_client_2.call(param_cruise_90_2))
    {
        ROS_INFO("UAV2 MPC_CRUISE_90 parameter change is called!");
        sleep(2);
    }
    ...
    if(set_max_vel_client_2.call(param_z_vel_max_2))
    {
        ROS_INFO("UAV2 MPC_Z_VEL_MAX_UP parameter change is called!");
        sleep(2);
    }
